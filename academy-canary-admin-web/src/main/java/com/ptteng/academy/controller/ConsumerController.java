...
public class ConsumerController {
    ...
    public ResponseVO getAuthor(@NotNull(message = "id不能为空") @PathVariable("id") Long id) throws Exception {
    ...
    public ResponseVO deleteAuthor(@NotNull(message = "id不能为空") @PathVariable("id") Long id) throws Exception {
    ...
    @PostMapping("/author")
    public ResponseVO createAuthor(@RequestBody @Valid AuthorDto authorDto) throws Exception {
    ...
    @PostMapping("/users")
    public ResponseRowsVO queryUser(@Valid @RequestBody UserQuery userQuery) throws ParseException, UnsupportedEncodingException, Exception {
    ...
    public ResponseVO setStatus(@Min(value = 0, message = "不能小于0") @PathVariable("id") Long id) throws Exception {
/*        User user = userMapper.selectByPrimaryKey(id);
    ...
    @RequiresPermissions(".user")
    @GetMapping("/user/{id}")
    public ResponseVO getUser(@Min(value = 0, message = "不能小于0") @PathVariable("id") Long id) throws Exception {
