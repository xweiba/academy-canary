...
public class ShiroConfig {
    ...
    public AuthorizationAttributeSourceAdvisor authorizationAttributeSourceAdvisor(SecurityManager securityManager) {
        System.out.println("authorizationAttributeSourceAdvisor() 执行了");
    ...
    public SimpleMappingExceptionResolver creatSimpleMappingExceptionResolver() {
        System.out.println("creatSimpleMappingExceptionResolver() 执行了");
        SimpleMappingExceptionResolver simpleMappingExceptionResolver = new SimpleMappingExceptionResolver();
        Properties mappings = new Properties();
        mappings.setProperty("DatabaseException", "databaseError"); // 数据库异常
        mappings.setProperty("UnauthorizedException", "/403"); // 捕获权限认证链异常
