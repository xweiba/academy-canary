...
public class VideoQuery extends IQuery{
    ...
    public VideoQuery(String title, Integer classify, Integer grade, Integer subject, Integer[] praise, Integer[] collect, String author, Boolean status) {
        this.title = title;
